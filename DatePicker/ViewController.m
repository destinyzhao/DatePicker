...
- (void)viewDidLoad {
    ...
    NSArray *arr = @[@"年-月-日-时-分",@"年-月-日-时",@"月-日-时-分",@"年-月-日",@"年-月",@"月-日",@"时-分",@"指定日期2011-11-11 11:11"];
...
- (void)selectAction:(UIButton *)btn {
    ...
    switch (btn.tag) {
        ...
        {
            //月-日-时-分
            JXDatePickerView *datepicker = [[JXDatePickerView alloc] initWithDateStyle:DateStyleShowMonthDayHourMinute CompleteBlock:^(NSDate *selectDate) {
        ...
        {
            //年-月
            JXDatePickerView *datepicker = [[JXDatePickerView alloc] initWithDateStyle:DateStyleShowYearMonth CompleteBlock:^(NSDate *selectDate) {
        ...
        {
            //时-分
            JXDatePickerView *datepicker = [[JXDatePickerView alloc] initWithDateStyle:DateStyleShowHourMinute CompleteBlock:^(NSDate *selectDate) {
        ...
        case 7:
        {
            ...
            JXDatePickerView *datepicker = [[JXDatePickerView alloc] initWithDateStyle:DateStyleShowYearMonthDayHourMinute scrollToDate:scrollToDate CompleteBlock:^(NSDate *selectDate) {
